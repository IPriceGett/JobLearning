                ...
                >
                    {({ touched, errors }) => (
                        ...
                        >
                            ...
                            <div className='text-md justify-center text-center'>
                                O
                            </div>
                            ...
                            <div className='flex justify-center '>
                                <button className='text-white bg-[#FF8900] hover:bg-[#e17c07]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-md px-5 py-2.5 text-center justify-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mb-2 w-full sm:w-auto flex-grow'>
