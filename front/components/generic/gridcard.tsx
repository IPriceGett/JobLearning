...
const GridCard = ({ title, desc, photo, precio }: Props): JSX.Element => {
    return (
        <div className='bg-zinc-900 text-white hover:bg-zinc-950 transition w-full h-full rounded-xl p-2 shadow-md'>
