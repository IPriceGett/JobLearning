...
const create = async (req, res, next) => {
    ...
    db.query("INSERT into job (created_at,updated_at,name,description,price,creator,category_fk) VALUES (?, ?, ?, ?, ?, ?, ?) ",
    [fecha,fecha,req.body.name,req.body.description,req.body.price,req.user.id,req.body.category],(error, results) => {
        if (error){
            console.log(error)
